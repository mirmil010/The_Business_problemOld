...
namespace The_Business_problem.NORTHWNDDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [LastName] = @LastName WHERE (([EmployeeID] = @Origi" +
                "nal_EmployeeID) AND ([LastName] = @Original_LastName));\r\nSELECT EmployeeID, Last" +
                "Name FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName FROM dbo.Employees";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_LastName) {
        ...
        public virtual int Update(string LastName, int Original_EmployeeID, string Original_LastName, int EmployeeID) {
            if ((LastName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string LastName, int Original_EmployeeID, string Original_LastName) {
            return this.Update(LastName, Original_EmployeeID, Original_LastName, Original_EmployeeID);
        }
    }
