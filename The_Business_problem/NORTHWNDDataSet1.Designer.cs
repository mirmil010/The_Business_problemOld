...
namespace The_Business_problem.NORTHWNDDataSet1TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([" +
                "LastName] = @Original_LastName) AND ([FirstName] = @Original_FirstName))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([LastName], [FirstName]) VALUES (@LastName, @First" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [LastName] = @LastName, [FirstName] = @FirstName WHERE (([EmployeeID] = @Original_EmployeeID) AND ([LastName] = @Original_LastName) AND ([FirstName] = @Original_FirstName));
SELECT EmployeeID, LastName, FirstName FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, FirstName FROM dbo.Employees";
        ...
        public virtual int Fill(NORTHWNDDataSet1.EmployeesDataTable dataTable) {
        ...
        public virtual NORTHWNDDataSet1.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            NORTHWNDDataSet1.EmployeesDataTable dataTable = new NORTHWNDDataSet1.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(NORTHWNDDataSet1.EmployeesDataTable dataTable) {
        ...
        public virtual int Update(string LastName, string FirstName, int Original_EmployeeID, string Original_LastName, string Original_FirstName, int EmployeeID) {
            if ((LastName == null)) {
                throw new global::System.ArgumentNullException("LastName");
            }
            else {
        ...
        public virtual int Update(string LastName, string FirstName, int Original_EmployeeID, string Original_LastName, string Original_FirstName) {
            return this.Update(LastName, FirstName, Original_EmployeeID, Original_LastName, Original_FirstName, Original_EmployeeID);
        }
    }
